# English Beyond Language — Logo Application Rules

## Status

`HUMAN_PREFERENCE` + `PROJECT_DECISION` + `APPROVED_RULE`
...
When placing or replacing the logo, do not change:
...
If a slide already contains a logo:
